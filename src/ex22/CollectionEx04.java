...
public class CollectionEx04 {
    public static void main(String[] args) {
        ...
        int num = r.nextInt(45) + 1, same = 0; // 랜덤으로 들어가는 숫자, 맞춘횟수
        boolean bonus = false;
        ...
        if (chance > 0) { // 기회가 있어야 진행가능
            ...
            // 보너스 번호
            lotto.add(num); // 보너스 번호 뽑기
            System.out.println("보너스 번호 : " + lotto.get(6)); // 보너스 번호 출력
            ...
            for (int i = 0; i < chanceLotto.size(); i++) { // i = 기회
                ...
                for (int j = 0; j < 6; j++) { // j = 로또 당첨 번호
                    for (int k = 0; k < 6; k++) { // k = 내가 뽑은 번호
                        if (lotto.get(j) == chanceLotto.get(i).get(k)) { // lotto.get(j) = 로또 당첨번호
                                                                         // chanceLotto.get(i) =기회
                                                                         // chanceLotto.get(i).get(k) = 내가 뽑은 번호
                            same++; // 당첨번호와 뽑은번호가 맞으면 맞춘갯수 1씩 증가
                        }
                        if (lotto.get(6) == chanceLotto.get(i).get(k)) { // 보너스 번호 확인
                            bonus = true;
                        }
                    }
                }
                ...
                // 당첨 확인 출력
                if (same > 2) { // 맞춘갯수가 3이상 있으면
                    System.out.println("당첨입니다");
                } else if (same == 3) {
                    System.out.println(same + "개 맞았습니다 5등입니다");
                } else if (same == 4) {
                    System.out.println(same + "개 맞았습니다 4등입니다");
                } else if (same == 5 && bonus == false) {
                    System.out.println(same + "개 맞았습니다 3등입니다");
                } else if (same == 5 && bonus == true) {
                    System.out.println(same + "개 와 보너스번호가 맞았습니다 2등입니다");
                } else if (same == 6) {
                    System.out.println(same + "개 맞았습니다 1등입니다");
                } else { // 맞춘갯수가 0이면
                    System.out.println("꽝입니다");
                }
                same = 0; // 한번의 기회가 끝나면 맞춘갯수 초기화
                bonus = false; // 보너스도 초기화
            }
        } else {
            System.out.println("돈을 1000원 이상 넣어주세요");
        }
    }
}
